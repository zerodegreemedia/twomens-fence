...
const ROUTES = [
  ...
  "/services/gate-installation",
  "/services/deck-building",
  "/services/tree-trimming",
  "/blog",
  "/blog/how-much-does-a-fence-cost-in-delaware",
  "/blog/wood-vs-vinyl-fence-which-is-right-for-you",
  "/blog/do-i-need-a-permit-for-a-fence-in-delaware",
  "/blog/best-fence-for-dogs-delaware-homeowners-guide",
  "/blog/pool-fence-requirements-delaware",
  "/thank-you",
  "/gallery",
  "/faq",
  "/contact",
